...
HUMAN_ERRORS = {
    ...
    "empty": "One of the files was empty. Please upload a JPG, JPEG, or PNG image.",
    "too_large": "Each image must be 10 MB or smaller.",
    "unsupported": "Only JPG, JPEG, and PNG images are supported.",
    "not_image": "One of the files is not a valid JPG, JPEG, or PNG image.",
